...
import { Bot, Plus, Search, Clock, Code2, Trash2, Pencil, MoreHorizontal, Copy, Download } from "lucide-react";
      ...
      <nav className="border-b border-border/30 bg-background/60 backdrop-blur-xl sticky top-0 z-50">
        <div className="container mx-auto flex items-center justify-between h-16 px-4">
          <Link to="/" className="flex items-center gap-2.5">
            ...
            <span className="font-black text-xl">CodeAgent</span>
          </Link>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <Badge
                        variant="outline"
                        className={`text-xs shrink-0 ${project.status === 'active' ? 'border-agent-coder/30 text-agent-coder' : 'border-border/50'}`}
                      >
                        {project.status}
                      </Badge>
                    </div>
